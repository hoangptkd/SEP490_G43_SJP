    ...
    <div className="app-shell">
      <header className={`topbar ${scrolled ? 'scrolled' : ''}`}>
        ...
        <div className="topbar-actions">
          {!token && (
            <>
              <Link to="/employer" className="button-link outline" style={{ minHeight: 36, marginRight: 8, borderColor: 'transparent', color: 'var(--primary)', background: '#f0f9ff' }}>
                Đăng tuyển
              </Link>
    ...
    <div className="home-shell">
      <header className={`home-topbar ${scrolled ? 'scrolled' : ''}`}>
        ...
        <div className="home-topbar-actions">
          {!token ? (
            <>
              <Link to="/employer" className="button-link outline" style={{ minHeight: 38, marginRight: 8, borderColor: 'transparent', color: 'var(--primary)', background: '#f0f9ff' }}>
                Đăng tuyển
              </Link>
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      await authService.register({
        ...
        password,
        role,
        ...(role === 'EMPLOYER' ? { fullName: fullName.trim(), phone: phone.trim(), gender, industries } : {})
      });
        ...
        {role === 'EMPLOYER' && (
          <>
            ...
            <a className="btn-google" href="#" onClick={(e) => {
              e.preventDefault();
              document.cookie = "oauth_preferred_role=EMPLOYER; path=/; max-age=3600";
